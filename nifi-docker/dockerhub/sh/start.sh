...
prop_replace 'nifi.web.http.network.interface.default' "${NIFI_WEB_HTTP_NETWORK_INTERFACE_DEFAULT:-}"
prop_replace 'nifi.web.http.network.interface.lo' "${NIFI_WEB_HTTP_NETWORK_INTERFACE_LO:-}"
